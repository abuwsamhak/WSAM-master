...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(wsam..":NameBot:")
...
var = 'هذا البوت 🙄☝🏿' 
elseif UserID == 804095303 then 
var = 'مطور السورس 👨🏻‍🔧'
elseif  UserID == SUDO_ID then
var = 'مطور اساسي 👨🏻‍✈️' 
elseif redis:sismember(wsam..':SUDO_BOT:',UserID) then
var = 'مطور البوت 👨🏽‍💻' 
elseif redis:sismember(wsam..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء 👷🏽' 
elseif redis:sismember(wsam..'owners:'..ChatID,UserID) then
var = 'مدير البوت 👨🏼‍⚕️' 
elseif redis:sismember(wsam..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت 👨🏼‍🎓' 
elseif redis:sismember(wsam..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز ⭐️' 
else
var = 'فقط عضو 🙍🏼‍♂️' 
end
...
if msg.edited then
redis:incr(wsam..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info_ then
redis:incr(wsam..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.content_.ID == "MessageChatAddMembers" then 
redis:incr(wsam..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessagePhoto" then
redis:incr(wsam..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageSticker" then
redis:incr(wsam..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageVoice" then
redis:incr(wsam..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageAudio" then
redis:incr(wsam..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageVideo" then
redis:incr(wsam..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageAnimation" then
redis:incr(wsam..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(wsam..':SUDO_BOT:')
SUDO_USER = SUDO_USER:gsub([[\_]],"_")
message = '👨🏽‍💻*¦* قائمه الـمـطـوريـن : \n\n`★`*_* ['..SUDO_USER..'] ➣ (`' ..SUDO_ID.. '`){'..redis:scard(wsam..'mtwr_count'..SUDO_ID)..'}\n*----------------------------------*\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n📛 *"
else
for k,v in pairs(list) do
local info = redis:hgetall(wsam..'username:'..v)
local count = redis:scard(wsam..'mtwr_count'..v)
...
local monsha = redis:smembers(wsam..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
local list = redis:smembers(wsam..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(wsam..'admins:'..msg.chat_id_)
...
local list = redis:smembers(wsam..'whitelist:'..msg.chat_id_)
...
if redis:sismember(wsam..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(wsam..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(wsam..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(wsam..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(wsam..'gban_users')
...
local list = redis:smembers(wsam..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(wsam..':Filter_Word:'..msg.chat_id_,word) then 
return  "📝*¦* الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع✓️" 
else
redis:sadd(wsam..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(wsam..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(wsam..':Filter_Word:'..msg.chat_id_,word) 
...
local NumberFlood = tonumber(redis:get(wsam..':Flood_Spam:'..User..':'..ChatID..':msgs') or 0)
if NumberFlood >= Flood then 
result = false
else
redis:setex(wsam..':Flood_Spam:'..User..':'..ChatID..':msgs',2,NumberFlood+1)
result = true
end
return result
end
...
json_data = '{"BotID": '..wsam..',"UserBot": "'..Bot_User..'","Groups" : {'
local All_Groups_ID = redis:smembers(wsam..'group:ids')
for key,GroupS in pairs(All_Groups_ID) do
local NameGroup = (redis:get(wsam..'group:name'..GroupS) or '')
...
local admins = redis:smembers(wsam..'admins:'..GroupS)
if #admins ~= 0 then
json_data =  json_data..',"Admins" : {'
for key,value in pairs(admins) do
local info = redis:hgetall(wsam..'username:'..value)
if info then 
...
local creator = redis:smembers(wsam..':MONSHA_BOT:'..GroupS)
if #creator ~= 0 then
...
local owner = redis:smembers(wsam..'owners:'..GroupS)
if #owner ~= 0 then
...
local list = redis:smembers(wsam..'group:ids')
message = '📋*¦* قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(wsam..'group:name'..v)
if info then 
...
redis:del(
wsam..'group:add'..id_group,
wsam..'lock_link'..id_group, 
wsam..'lock_id'..id_group,
wsam..'lock_spam'..id_group, 
wsam..'lock_webpage'..id_group,
wsam..'lock_markdown'..id_group,
wsam..'lock_flood'..id_group,
wsam..'lock_bots'..id_group,
wsam..'mute_forward'..id_group,
wsam..'mute_contact'..id_group,
wsam..'mute_location'..id_group,
wsam..'mute_document'..id_group,
wsam..'mute_keyboard'..id_group,
wsam..'mute_game'..id_group,
wsam..'mute_inline'..id_group,
wsam..'lock_username'..id_group,
wsam..'num_msg_max'..id_group,
wsam..'mute_text'..id_group,
wsam..'admins:'..id_group,
wsam..':Filter_Word:'..id_group,
wsam..'banned:'..id_group,
wsam..'is_silent_users:'..id_group,
wsam..'whitelist:'..id_group,
wsam..':MONSHA_BOT:'..id_group,
wsam..'owners:'..id_group,
wsam..':lock_id_photo:'..id_group,
wsam..'replay'..id_group
)
redis:srem(wsam..'group:ids',id_group)
end
...
NumAdmin = NumAdmin + 1
if not redis:sismember(wsam..'admins:'..arg.chat_id_,v.user_id_) then
GetUserID(v.user_id_,function(arg,data)
redis:hset(wsam..'username:'..data.id_,'username',ResolveUserName(data))
redis:sadd(wsam..'admins:'..arg.chat_id_,data.id_)
...
if redis:get(wsam..'group:add'..msg.chat_id_) then  return '🎗*¦* المجموعه بالتأكيد ✓️ تم تفعيلها' end
...
local GroupUsers = tonumber(redis:get(wsam..':addnumberusers') or 0)
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(wsam..'username:'..data.id_,'username', ResolveUserName(data))
redis:sadd(wsam..':MONSHA_BOT:'..arg.chat_id_,data.id_)
...
redis:mset(
wsam..'group:add'..arg.chat_id_,true,
wsam..'lock_id'..arg.chat_id_,true, 
wsam..'lock_link'..arg.chat_id_,true, 
wsam..'lock_spam'..arg.chat_id_,true,
wsam..'lock_webpage'..arg.chat_id_,true,
wsam..'lock_markdown'..arg.chat_id_,true,
wsam..'lock_flood'..arg.chat_id_,true,
wsam..'lock_bots'..arg.chat_id_,true,
wsam..'mute_forward'..arg.chat_id_,true,
wsam..'mute_contact'..arg.chat_id_,true,
wsam..'mute_location'..arg.chat_id_,true,
wsam..'mute_document'..arg.chat_id_,true,
wsam..'mute_keyboard'..arg.chat_id_,true,
wsam..'mute_game'..arg.chat_id_,true,
wsam..'mute_inline'..arg.chat_id_,true,
wsam..'lock_username'..arg.chat_id_,true,
wsam..'num_msg_max'..arg.chat_id_,5, 
wsam..'lock_edit'..arg.chat_id_,true,
wsam..'replay'..arg.chat_id_,true,
wsam..':lock_id_photo:'..arg.chat_id_,true
)
redis:sadd(wsam..'group:ids',arg.chat_id_) 
redis:sadd(wsam..'mtwr_count'..arg.sender_user_id_,arg.chat_id_)

local NameGroup = data.title_
redis:set(wsam..'group:name'..arg.chat_id_,NameGroup)
...
redis:set(wsam..'linkGroup'..arg.chat_id_,Gp_Link)
...
redis:hset(wsam..'username:'..UserID, 'username', Resolv)
redis:sadd(wsam..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ تم تقييد آلعضـو بنجآح \n✓️',12,USERCAR) 
end 
if cmd =="fktqeed" then
Restrict(ChatID,UserID,2)
redis:srem(wsam..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ تم فگ تقييد آلعضـو بنجآح \n✓️',12,USERCAR) 
end
if cmd == "setwhitelist" then
if redis:sismember(wsam..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ انه بالتأكيد من عضو مميز \n✓️',12,USERCAR) 
end
redis:hset(wsam..'username:'..UserID, 'username', Resolv)
redis:sadd(wsam..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ تمت ترقيته ليصبح ضمن عضو مميز \n✓️',12,USERCAR) 
end
if cmd == "setmnsha" then
if redis:sismember(wsam..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ انه بالتأكيد منشىء \n✓️',12,USERCAR) 
end
redis:hset(wsam..'username:'..UserID, 'username', Resolv)
redis:sadd(wsam..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ تمت ترقيته ليصبح منشىء في البوت \n✓️',12,USERCAR) 
end
if cmd == "remmnsha" then
if not redis:sismember(wsam..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ انه بالتأكيد ليس منشىء \n✓️',12,USERCAR) 
end
redis:srem(wsam..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ تم تنزيله من المنشىء \n✓️',12,USERCAR) 
end
if cmd == "remwhitelist" then
if not redis:sismember(wsam..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ انه بالتأكيد ليس من عضو مميز \n✓️',12,USERCAR) 
end
redis:srem(wsam..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ تمت تنزيله من عضو مميز \n✓️',12,USERCAR) 
end
if cmd == "setowner" then
if redis:sismember(wsam..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ انه بالتأكيد مدير \n✓️',12,USERCAR) 
end
redis:hset(wsam..'username:'..UserID, 'username', Resolv)
redis:sadd(wsam..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ تمت ترقيته ليصبح مدير \n✓️',12,USERCAR) 
end
if cmd == "promote" then
if redis:sismember(wsam..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ انه بالتأكيد ادمن \n✓️',12,USERCAR) 
end
redis:hset(wsam..'username:'..UserID, 'username', Resolv)
redis:sadd(wsam..'admins:'..ChatID,UserID) 
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ تمت ترقيته ليصبح ادمن \n✓️',12,USERCAR) 
end
if cmd == "remowner" then
if not redis:sismember(wsam..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ انه بالتأكيد ليس مدير \n✓️',12,USERCAR) 
end
redis:srem(wsam..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ تم تنزيله من الاداره \n✓️',12,USERCAR) 
end
if cmd == "demote" then
if not redis:sismember(wsam..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ انه بالتأكيد ليس ادمن \n✓️',12,USERCAR) 
end
redis:srem(wsam..'admins:'..ChatID,UserID)
...
if cmd == "dn_sudo" then
if not redis:sismember(wsam..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'👤*¦* العضو » '..USERNAME..' \n🎫*¦* الايدي » (`'..UserID..'`)\n🛠*¦* انه بالتأكيد ليس مطور \n✓') end
...
redis:hset(wsam..'username:'..UserID, 'username', Resolv)
redis:sadd(wsam..'banned:'..ChatID,UserID)
...
redis:hset(wsam..'username:'..UserID, 'username', Resolv)
redis:srem(wsam..'banned:'..ChatID,UserID)
StatusLeft(ChatID,UserID)
return false
end
...
redis:hset(wsam..'username:'..UserID, 'username', Resolv)
redis:sadd(wsam..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ تم كتمه  \n✓️',12,USERCAR) 
end
...
redis:hset(wsam..'username:'..UserID, 'username', Resolv)
redis:srem(wsam..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'👤¦ العضو » '..USERNAME..' \n🎫¦ الايدي » {'..UserID..'}\n🛠¦ تم الغاء كتمه \n✓️',12,USERCAR) 
end
...
if redis:get(wsam..'welcome:get'..msg.chat_id_) then welcomex = "{ مفعل }" else welcomex = "{ معطل }" end
if redis:get(wsam..'lock_id'..msg.chat_id_) then lock_idx = "{ مفعل }" else lock_idx = "{ معطل }" end
if redis:get(wsam..'replay'..msg.chat_id_)  then replayx  = "{ مفعل }" else replayx  = "{ معطل }" end
if redis:get(wsam..'lock_woring'..msg.chat_id_) then lock_woringx = "{ مفعل }" else lock_woringx  = "{ معطل }" end
list_settings = "*👮🏾¦*` اعدادات المجموعه :` \n"
.."\n📝¦ التعديل » "..(redis:get(wsam..'lock_edit'..msg.chat_id_) or 'false')
.."\n🔗¦ الروابط » "..(redis:get(wsam..'lock_link'..msg.chat_id_) or 'false')
.."\n#️⃣¦ التاك » "..(redis:get(wsam..'lock_tag'..msg.chat_id_) or 'false')
.."\n©¦ المعرفات » "..(redis:get(wsam..'lock_username'..msg.chat_id_) or 'false')
.."\n\n💱¦ التكرار » "..(redis:get(wsam..'lock_flood'..msg.chat_id_) or 'false')
.."\n📑¦ الكلايش » "..(redis:get(wsam..'lock_spam'..msg.chat_id_) or 'false')
.."\n🌐¦ الويب » "..(redis:get(wsam..'lock_webpage'..msg.chat_id_) or 'false')
.."\n⚜️¦ الماركدوان » "..(redis:get(wsam..'lock_markdown'..msg.chat_id_) or 'false')
.."\n🏌🏻¦ البوتات بالطرد » "..(redis:get(wsam..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n🤖¦ البوتات » "..(redis:get(wsam..'lock_bots'..msg.chat_id_) or 'false')
.."\n➕¦ عدد التكرار » "..(redis:get(wsam..'num_msg_max'..msg.chat_id_) or 'false')
.."\n\n🎬¦` اعدادات الوسائط :`\n"
.."\n*¦* المتحركه » "..(redis:get(wsam..'mute_gif'..msg.chat_id_) or 'false')
.."\n💭¦ الدردشه » "..(redis:get(wsam..'mute_text'..msg.chat_id_) or 'false')
.."\n◽️¦ الانلاين » "..(redis:get(wsam..'mute_inline'..msg.chat_id_) or 'false')
.."\n🎮¦ الالعاب » "..(redis:get(wsam..'mute_game'..msg.chat_id_) or 'false')
.."\n🏞¦ الصور » "..(redis:get(wsam..'mute_photo'..msg.chat_id_) or 'false')
.."\n🎥¦ الفيديو » "..(redis:get(wsam..'mute_video'..msg.chat_id_) or 'false')
.."\n🎙¦ البصمات » "..(redis:get(wsam..'mute_audio'..msg.chat_id_) or 'false')
.."\n\n🔉¦ الصوت » "..(redis:get(wsam..'mute_voice'..msg.chat_id_) or 'false')
.."\n🎎¦ الملصقات » "..(redis:get(wsam..'mute_sticker'..msg.chat_id_) or 'false')
.."\n📞¦ الجهات » "..(redis:get(wsam..'mute_contact'..msg.chat_id_) or 'false')
.."\n💱¦ التوجيه » "..(redis:get(wsam..'mute_forward'..msg.chat_id_) or 'false')
.."\n🌐¦ الموقع » "..(redis:get(wsam..'mute_location'..msg.chat_id_) or 'false')
.."\n🗂¦ الملفات » "..(redis:get(wsam..'mute_document'..msg.chat_id_) or 'false')
.."\n🔅¦ الاشعارات » "..(redis:get(wsam..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n🔒¦ الكيبورد » "..(redis:get(wsam..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\n*⚒¦*` اعدادات اخرى : `"
.."\n*🙋🏼‍♂️¦* الترحيب » "..welcomex
.."\n*💬¦*  الردود » "..replayx
...
.."\n*➕¦* عدد التكرار » "..(redis:get(wsam..'num_msg_max'..msg.chat_id_) or 'false')
.."\n\n*💱¦*` اعدادات التقـييد :`\n"
.."\n*💢¦* التقييد بالتوجيه » "..(redis:get(wsam..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*📸¦* التقييد بالصور » "..(redis:get(wsam..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*🔗¦* التقييد بالروابط » "..(redis:get(wsam..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*🎉¦* التقييد بالمتحركه » "..(redis:get(wsam..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*🎥¦* التقييد الفيديو » "..(redis:get(wsam..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
